...
p1_pre_filter <- DimPlot(object = rnaseq_obj, group.by="main_bencode", pt.size=1.0, label.size = 10, alpha = 0.7,label = T,reduction = "umap")
...
# post filter umap
p2_post_filter <- DimPlot(object = rnaseq_obj, group.by="main_bencode", pt.size=1.0, label.size = 10, alpha = 0.7,label = T,reduction = "umap")
plot_grid(p1_pre_filter,p2_post_filter,ncol = 2)
```

# 4. Add columns to VDJ data
* This code block gets stuck when running. To fix this press <enter> in the R console
```{r}
# Add sample column
