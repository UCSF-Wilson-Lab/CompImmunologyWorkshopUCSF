...
# 1. Hamming Distances across BCR data
```{r}
bcr_data <- read.delim(imm_heavy_results_fh,stringsAsFactors = F)

dist_nearest <- distToNearest(bcr_results_igh)

# Automated Thresholding - takes too long to run
...
# 6. Mutational Profile of B cells
...
# 7. Mutational hot spots Observed among all 5-mers - B cells
